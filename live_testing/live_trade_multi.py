...
class LiveTraderMulti:
    ...
    def __init__(self, model_path, detection_threshold=0.7, persistence_threshold=0.5, 
        ...
        if not model_data.get('multi_task', False):
            raise ValueError("Model is not multi-task!")
        
        self.model_detection = model_data['model_detection']
        self.model_persistence = model_data['model_persistence']
...
def main():
    ...
    print("Live Trading - Multi-Task Model")
    print("=" * 40)
